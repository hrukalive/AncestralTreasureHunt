...
public:	
	...
	UFUNCTION(BlueprintCallable)
		void GenerateTilemap(
			...
			UPARAM(DisplayName = "Use Rectangular Region") bool UseRectRegion = false,
			UPARAM(DisplayName = "Region Radius X") float RadiusX = 1.0f,
			UPARAM(DisplayName = "Region Radius Y") float RadiusY = 1.0f,
